...
// const VideoPlayer = (width, height, controls, src, type) => {
...
//     return VideoPlayer(width, height, controls, src, type)

// }
const VideoPlayer = (props) => {
    console.log(props)
    return <video width={props.width} height={props.height} controls={props.controls}>
